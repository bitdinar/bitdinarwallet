...
public class FingerprintActivity extends BRActivity {
    ...
    private String getLimitText() {
        ...
        BigDecimal amount = BRExchange.getAmountFromSatoshis(this, "DTC", satoshis);
        ...
        return String.format(getString(R.string.TouchIdSettings_spendingLimit), BRCurrency.getFormattedCurrencyString(this, "DTC", amount), BRCurrency.getFormattedCurrencyString(this, iso, curAmount));
    }
